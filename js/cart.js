document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateCartCounter = () => {
        ...
        // Disparar evento personalizado para que main.js actualice la burbuja también
    ...
    const checkoutToWhatsApp = () => {
        ...
        const phoneNumber = "573223394935"; // ¡IMPORTANTE! Reemplazar con el número del cliente
